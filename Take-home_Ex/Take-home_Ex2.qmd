...
We also use [shapiro.test](https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/shapiro.test) to test for normality in the code chunk below. Should the p-value is greater than 0.05, the data is normal. If it is below 0.05, the data deviate from a normal distribution.
